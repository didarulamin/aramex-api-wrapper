...
function getCountryCodeByCurrency(currencyCode) {
    const match = countryCurrencyData.find(entry => entry.currencyCode === currencyCode);
    return match ? match.countryCode : null; // Return country code or null if not found
}
